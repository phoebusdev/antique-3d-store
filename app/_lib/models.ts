...
export const MODELS: AntiqueModel[] = [
  {
    ...
    provenance: 'Carved marble relief from Florence workshop tradition, digitized from museum collection. Load-bearing capable (structural integration) or facade-mounted. CAD-editable STEP format allows dimensional scaling 80%-120% of base. Available in limestone, sandstone, marble. Volume pricing for 10+ pieces. Suitable for residential facades, chapel installations, or institutional buildings.',
  ...
  },
  {
    ...
    provenance: 'Gothic cathedral relief panel from Northern France UNESCO site, digitized during restoration documentation. Architectural integration or standalone ornamental panel. Parametric scaling supports column capitals, tympanum installations, or facade elements. CNC-ready for limestone, sandstone, marble. Volume pricing available for building-scale projects (10+ pieces). Ideal for institutional, civic, or residential Gothic-inspired architecture.',
  ...
  },
  {
    ...
    provenance: 'Temple of Athena frieze element from Asia Minor archaeological site (Museum catalog DP317611). Acanthus leaf and mythological frieze patterns. Structural frieze integration or ornamental panel mounting. Scalable 70%-130% for varying architectural scales. CNC-optimized for limestone, marble, sandstone. Volume orders (10+ pieces) for building facade applications. Suitable for classical revival residential, commercial, or civic projects.',
